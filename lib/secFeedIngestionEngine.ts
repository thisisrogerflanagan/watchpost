...
export class SECFeedIngestionEngine {
  ...
  public async fetchLiveFeed(url?: string): Promise<string> {
  ...
  public async saveSignalsToSupabase(
    signals: ParsedFilingSignal[],
    supabaseUrl?: string,
    supabaseKey?: string
  ): Promise<number> {
...
export async function ingestLatestFilings(options: IngestionOptions = {}): Promise<IngestionResult> {
